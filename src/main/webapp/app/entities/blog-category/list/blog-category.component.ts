...
export class BlogCategoryComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.blogCategoryService
      ...
      .subscribe(
        (res: HttpResponse<IBlogCategory[]>) => {
  ...
  trackId(index: number, item: IBlogCategory): string {
    return item.id!;
  }
  ...
  protected onSuccess(data: IBlogCategory[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
