...
describe('Component Tests', () => {
  describe('ServiceReview Management Component', () => {
    let comp: ServiceReviewComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ServiceReviewComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.serviceReviews?.[0]).toEqual(jasmine.objectContaining({ id: 'ABC' }));
    });
